...
import { L as ListenOptions, a as Listener } from './shared/listhen.02f58cd3.mjs';
export { C as Certificate, G as GetURLOptions, H as HTTPSOptions, b as ListenURL, S as ShowURLOptions } from './shared/listhen.02f58cd3.mjs';
import { ConsolaInstance } from 'consola';
import * as h3 from 'h3';
import { WebSocketHooks } from 'crossws';
import 'node:https';
import 'node:net';
...
declare function createDevServer(entry: string, options: DevServerOptions): Promise<{
    ...
    _ws: Partial<WebSocketHooks> | undefined;
